    ...
    public class ClientHome
    {
        ...
        private void RotateShopContent(DateTime time, bool isNewAcc)
        {
            ...
            foreach (OfferBundle o in OfferBundles)
            {
                ...
                if (o.Title == "Big Box")
                {
                    SHOULD_STAR_BIGBOX1 = false;
                }
                if (o.Title == "Big Box x2")
                {
                    SHOULD_STAR_BIGBOX2 = false;
                }
                if (o.Title == "Mega Box")
                {
                    SHOULD_STAR_MEGABOX1 = false;
                }
                if (o.Title == "Mega Box x2")
                {
                    SHOULD_STAR_MEGABOX2 = false;
                }
                if (o.Title == "Mega Box x3")
                {
                    SHOULD_STAR_MEGABOX3 = false;
                }
                ...
                {
                    SHOULD_COMPENSACIA = false;
                }

            }

            if (SHOULD_COMPENSACIA)
            {
                OfferBundle bundle = new OfferBundle();
                bundle.Title = "Mega Box";
            ...
            if (SHOULD_STAR_MEGABOX3)
            {
                OfferBundle bundle = new OfferBundle();
                bundle.Title = "Mega Box x3";
                bundle.IsDailyDeals = false;
                bundle.EndTime = DateTime.UtcNow.AddDays(14); // tomorrow at 8:00 utc (11:00 MSK)
                bundle.BackgroundExportName = "offer_legendary";
            ...
            if (SHOULD_STAR_BIGBOX1)
            {
                OfferBundle bundle = new OfferBundle();
                bundle.Title = "Big Box";
                bundle.IsDailyDeals = false;
                bundle.EndTime = DateTime.UtcNow.AddDays(14); // tomorrow at 8:00 utc (11:00 MSK)
                bundle.BackgroundExportName = "offer_legendary";
            ...
            if (SHOULD_STAR_BIGBOX2)
            {
                OfferBundle bundle = new OfferBundle();
                bundle.Title = "Big Box x2";
                bundle.IsDailyDeals = false;
                bundle.EndTime = DateTime.UtcNow.AddDays(14); // tomorrow at 8:00 utc (11:00 MSK)
                bundle.BackgroundExportName = "offer_legendary";
                Offer megaBoxOffer = new Offer(ShopItem.BigBox, 2);
                bundle.Items.Add(megaBoxOffer);
                bundle.Cost = 900;
                bundle.Currency = 3;
               //OfferBundles.Add(bundle);
        ...
        public void UpdateOfferBundles()
        {
            ...
            GenerateOffer(
                new DateTime(2025, 1, 17, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                1, 999, 56, ShopItem.Skin,
                0, 0, 0,
                "day6", "День 6", "offer_legendary"
            );

            GenerateOffer(
                new DateTime(2025, 1, 18, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                1, 26, 210, ShopItem.GuaranteedHero,
                0, 0, 0,
                "day7", "День 7", "offer_legendary"
            );

            GenerateOffer(
                new DateTime(2025, 1, 19, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                1, 999, 146, ShopItem.Skin,
                0, 0, 0,
                "day8", "День 8", "offer_legendary"
            );

            GenerateOffer(
                new DateTime(2025, 1, 20, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                2500, 999, 146, ShopItem.Coin,
                0, 0, 0,
                "day9", "День 9", "offer_legendary"
            );

            GenerateOffer(
                new DateTime(2025, 1, 21, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                10, 999, 146, ShopItem.MegaBox,
                0, 0, 0,
                "day10", "День 10", "offer_legendary"
            );

            GenerateOffer(
                new DateTime(2025, 1, 22, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                80, 999, 146, ShopItem.Gems,
                0, 0, 0,
                "day11", "День 11", "offer_legendary"
            );

            GenerateOffer(
                new DateTime(2025, 1, 23, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                1, 35, 146, ShopItem.GuaranteedHero,
                0, 0, 0,
                "day12", "День 12", "offer_legendary"
            );

            GenerateOffer(
                new DateTime(2025, 1, 24, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                150, 999, 146, ShopItem.Gems,
                0, 0, 0,
                "day13", "День 13", "offer_legendary"
            );

            GenerateOffer(
                new DateTime(2025, 1, 25, 11, 0, 0), new DateTime(2025, 1, 31, 11, 0, 0),
                1, 23, 146, ShopItem.GuaranteedHero,
                0, 0, 0,
                "day14", "День 14", "offer_legendary"
            );
        }
        ...
        public void LogicDailyData(ByteStream encoder, DateTime utcNow)
        {
            ...
            {
                ByteStreamHelper.WriteDataReference(encoder, 28000000);
                ByteStreamHelper.WriteDataReference(encoder, 43000000);
            }
            ...
            DateTime targetDateTime = new DateTime(2024, 5, 22, 18, 0, 0);
            ...
            DateTime BPtargetDateTime = new DateTime(2025, 2, 10, 17, 0, 0);
        ...
        public void LogicConfData(ByteStream encoder, DateTime utcNow)
        {
            ...
            {
                encoder.WriteInt(1);
                encoder.WriteInt(41000016); // theme
